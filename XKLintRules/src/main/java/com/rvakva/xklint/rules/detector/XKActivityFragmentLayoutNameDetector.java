 ...
 * @FileName: XKActivityFragmentLayoutNameDetector
 * @Author: hufeng
 * @Date: 2019/9/25 上午11:01
 * @Description:
 * @History:
 */
public class XKActivityFragmentLayoutNameDetector extends Detector implements Detector.UastScanner {

    private static final Class<? extends Detector> DETECTOR_CLASS = XKActivityFragmentLayoutNameDetector.class;
    ...
    private static final String ISSUE_ACTIVITY_ID = "XK_LayoutNamePrefixError";
    ...
    private static final String ISSUE_FRAGMENT_ID = "XK_LayoutNamePrefixError";
