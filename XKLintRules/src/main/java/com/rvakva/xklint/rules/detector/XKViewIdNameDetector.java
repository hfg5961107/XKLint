 ...
 * @FileName: XKViewIdNameDetector
 * @Author: hufeng
 * @Date: 2019/9/25 下午2:05
 * @Description:
 * @History:
 */
public class XKViewIdNameDetector extends ResourceXmlDetector {

    private static final Class<? extends Detector> DETECTOR_CLASS = XKViewIdNameDetector.class;
    ...
    private static final String ISSUE_ID = "XK_IdNameError";
